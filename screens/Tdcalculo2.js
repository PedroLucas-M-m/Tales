...
export default class App extends React.Component {
  ...
  calcular(){
   let A = (this.state.a * this.state.g) - (this.state.c * this.state.e)
   let B = (this.state.a * this.state.h)+(this.state.b * this.state.g)-(this.state.c* this.state.f)-(this.state.d * this.state.e)
   let C = (this.state.d * this.state.f)-(this.state.b * this.state.h)
   let s = this.state
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.Text}>
				Voce escolheu a Equaçao do tipo 2
   			</Text>
